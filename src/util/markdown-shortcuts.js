/**
 * Markdown keyboard-shortcut helpers for Onboard.qs.
 *
 ...
 * any external listeners stay in sync.
 *
 ...
 *
 * @module util/markdown-shortcuts
 */
...
/**
 * Fire a synthetic `input` event so that external listeners stay in
 * sync after programmatic edits.
 *
...
/**
 * Apply bold formatting to the current selection or insert placeholder.
 *
...
/**
 * Apply italic formatting to the current selection or insert placeholder.
 *
 * @param {HTMLTextAreaElement} ta - Target textarea.
 */
...
/**
 * Apply inline code formatting to the current selection or insert placeholder.
 *
 * @param {HTMLTextAreaElement} ta - Target textarea.
 */
...
/**
 * Insert a Markdown link wrapping the current selection or insert placeholder.
 *
 * @param {HTMLTextAreaElement} ta - Target textarea.
 */
...
/**
 * Toggle ordered list prefix on selected lines.
 *
 * @param {HTMLTextAreaElement} ta - Target textarea.
 */
...
/**
 * Toggle unordered list prefix on selected lines.
 *
 * @param {HTMLTextAreaElement} ta - Target textarea.
 */
 ...
 *
 * Listens for Ctrl/Cmd key combinations and applies the appropriate
 * Markdown formatting. Shortcuts mirror GitHub's editor conventions.
 *
